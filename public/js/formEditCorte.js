{
      ...
      $('#submitEditarCorte').click(function(){
            if( $("#coleccion").val() == "" ){
            ...
            text: "¡Se editara la información del corte!",
            icon: "warning",
            buttons: true,
            dangerMode: true,
            })
            .then((willDelete) => {
            if (willDelete) {
                swal("¡Listo! Los datos del corte se han actualizado.", {
                icon: "success",
                });
                $('#EditarCorte').submit();
            } 
      ...
      function largoTelaBTelaD(){
           ...
           $("#metroTB").val(mtrsTB.toFixed(2));

           let mtrsTD = $("#largot2_tela_dos").val() * $("#tendida2_tela_dos").val();
           $("#metroTD").val(mtrsTD.toFixed(2));
