...
class EnsambleExport implements FromArray, Responsable, WithHeadings, WithTitle
{
    use Exportable;
    
    private $listadoEnsamble;

    public function __construct($listadoEnsamble)
    {
        $this->listadoEnsamble = $listadoEnsamble;
    }
