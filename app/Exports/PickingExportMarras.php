...
class PickingExportMarras implements FromArray, Responsable, WithHeadings, WithTitle
{
    use Exportable;
    ...
    {
       $array = [];
       $rows = PickingTipoPrenda::where('id_referencia','=',$this->idConteoPrenda)->where('tipo_prenda','=','MARRAS')->get();
