        ...
        <div class="container-fluid">
            <div class="card m-2">
                <div class="card-header" style="background-color:#007bff !important; color:white;">
                    <center><h3><b>Listado Pendiente de Facturación</b> <b><span v-html="fechaActual"></span></b></h3></center>
                </div>
                <div class="card-body">
                        ...
                        <table id="tablaOrdenes" style="width:105%;" class="table">
                            ...
                            <tbody>
                                <tr v-for="orden in ordenesD">
                                    ...
                                    <td>
                                        <a v-if="orden.estado == 11" v-bind:href="'../facturacionPDF/generar/'+orden.consecutivo"><span class="badge badge-danger"><i class="fa fa-file-pdf"></i></span></a>
                                        <a v-bind:href="'../view-proceso/consecutivo/'+orden.consecutivo"><span class="badge badge-success"><i class="fa fa-eye"></i></span></a>
                                        <button type="button" v-on:click="updateConsecutivo(orden.consecutivo)" v-if="orden.estado == 5 || orden.estado == 11" style="cursor:pointer; border:none; background-color:none;" data-toggle="modal" data-target="#modalIngresarFacturas">
                                            <span class="badge badge-info"><i class="fa fa-file-invoice"></i></span>
                                        </button>
                                    </td>
                                </tr>
                            </tbody>
            ...
            <div class="modal fade" id="modalIngresarFacturas" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><h3>Ingresar Codigos de factura al Despacho ID: <span v-html="consecutivo"></span></h3></h5>
