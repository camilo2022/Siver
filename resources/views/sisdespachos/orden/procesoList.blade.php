...
@section('content')
<div id="apper">
    <a class="btn btn-info m-2" href="../../ordenes-despacho/pendienteFacturar">Volver</a>
                    ...
                    <table class="tablecurva">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{App\Models\Despachos\UserProyNew::where('id','=',App\Models\Despachos\PedidosPROYNEW::where('id','=',App\Models\Despachos\DetallesPedido::where('id','=',$detalle->id)->first()->pedido_id)->first()->user_id)->first()->username}}</td>
