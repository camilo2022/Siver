...
@section('content')
   <div id="appvuerrt">
      ...
      <div class="page-inner py-5">
        ...
        >
          <div>
            <h2 class="text-white fw-bold">Reprogramaciones Directora de Tiendas</h2>
          ...
          <div class="card full-height">
            <div class="card-body">
              <div  class="container">
                ...
                <button v-if="displayButton == true" class="btn btn-success w-100" @click="sincronizarProductos()"><i class="fa fa-sync"></i>Subir reprogramaciones</button>
            ...
            methods:{
                ...
                sincronizarProductos(){
                  if(this.file != ''){
                      ...
                      /*Se hace la peticion */
                       axios.post('reprogramaciones/subirPost',formData,config)
                       .then(response => {
                           this.displayButton=false
