   ...
   <div class="row">
       <div class="col-3"></div>
            <div class="col-6">
                ...
                <label style="text-align:center; width: 49%;">Orden Picking:<span class="badge badge-primary" id="orden" style="width:100%; font-size:20px; text-align:center;">{{$picking[0]->orden_picking}}</span></label>
                <label style="text-align:center; width: 49%;">Tipo Refrencia:<span class="badge badge-primary" id="tipo" style="width:100%; font-size:20px; text-align:center;">{{$picking[0]->tipo_referencia}}</span></label>
...
<script src="{{asset('js/repicking.js')}}"></script>       
