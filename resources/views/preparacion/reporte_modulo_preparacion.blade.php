...
<div class="container-fluid mt-2">
    ...
    REPORTE POR MODULO DE PREPARACION
    </div>
        <div class="card-body">
      ...
      @foreach($consultas as $consulta)
        <tr>
          ...
          @if($consulta->eficiencia>=0 && $consulta->eficiencia<70)
           ...
           @endif
          <td>
                <a type="button" class="" data-toggle="modal" data-target=".bd-example-modal-lg" onClick="dataUser('{{$consulta->fecha}}','{{$consulta->turno}}','{{$consulta->modulo}}');" style="cursor: pointer;"><span class="badge badge-info"><i class="fa fa-solid fa-eye"></i></span></a>
            </td>
        </tr>
        @endforeach
    </tbody>
...
function dataUser(fecha, turno, modulo){
    $('#mydatatable').DataTable().destroy().draw();
    var URLdominio = getAbsolutePath();
    var url = URLdominio + "modulo/consulta";
        $.ajax({
            url: url,
            type: 'GET',
            data: {
    ...
    $(document).ready(function(){
      ...
      },
      {
        ...
        footer: true,
        title: 'Organización Bless',
        filename: 'Reporte Preparacion Modulos',
