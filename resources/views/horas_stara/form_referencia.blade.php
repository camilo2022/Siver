...
<div class="container-fluid mt-2">
    ...
    FORMULARIO DE CREACIÓN DE REFERENCIAS STARA
    </div>
        <div class="card-body">
...
<body>
    <form method="" action="" id="referenciaForm" accept-charset="UTF-8" autocomplete="off">
        ...
        <br><br>
        <a href="{{route('list_referencias_stara')}}" class="btn btn-secondary" >Cancelar</a>
...
<script src="{{asset('js/form_referencia_stara.js')}}"></script>
@endpush