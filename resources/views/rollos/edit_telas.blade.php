...
<body>
    <form method="" action="" id="referenciaForm" accept-charset="UTF-8" autocomplete="off">
        @csrf
        <input type="number" class="" id="id" name="id" style="display:none;" value="{{$tela[0]->id}}">
        
        <label for="">Codigo:</label> 
        <input type="text" class="" id="codigo" name="codigo" value="{{$tela[0]->codigo}}">

        <label for="">Tela:</label> 
        <input type="text" class="" id="tela" name="tela" value="{{$tela[0]->tela}}">
...
$(document).ready(function(){
    ...
    var url = URLdominio +  id + "/telas_update";
    ...
    $.ajax({
          ...
          success: function(data){  
                ...
                window.location = "https://siversoftware.zarethpremium.com/telas/list";
            },
