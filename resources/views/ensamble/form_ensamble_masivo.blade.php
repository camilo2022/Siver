...
<div class="container-fluid mt-2">
    ...
    FORMULARIO DE CREACIÓN MASIVO ENSAMBLE
    </div>
        <div class="card-body">
            <div class="table-responsive">
<body onload="miFuncion('{{$errors->first()}}');"> 
    <form method="get" action="{{route('store_ensamble_masivo')}}" id="ensambleForm" accept-charset="UTF-8" autocomplete="off">
        ...
        <button type="submit" class="btn btn-primary" id="submitCrear" tabindex="9">Guardar</button>
    </form>
</body>
            </div>
        </div>
