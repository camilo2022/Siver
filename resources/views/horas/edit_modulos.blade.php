...
<div class="container-fluid mt-2">
    ...
    FORMULARIO DE EDICION CONFECCION
    </div>
...
<body>
    <form method="" action="" id="moduloForm" accept-charset="UTF-8" autocomplete="off">
        ...
        <select name="modulo" id="modulo" class="lista">
            <option value="{{$modulo[0]['modulo']}}" selected>Modulo {{$modulo[0]['modulo']}}</option>
        ...
        <input type="number" id="id_refe" style="display: none" value="{{$modulo[0]['id_referencia']}}">
...
<script src="{{asset('js/edit_modulos.js')}}"></script>
@endpush