    ...
    <tbody>
      @foreach($modulos as $modulo)
        <tr>
            ...
            <td>{{$modulo->turno}}</td>
            @if($modulo->modulo==0)
            <td>{{"Modulo Pilotos"}}</td>
            @elseif($modulo->modulo>0 && $modulo->modulo<=9)
            <td>{{"Modulo 0".$modulo->modulo}}</td>
            @elseif($modulo->modulo>9)
            <td>{{"Modulo ".$modulo->modulo}}</td>
            @endif
            ...
            <td>
              <form>
                <a href="{{route('eficiencia',$modulo->id)}}" class=""><span class="badge badge-success"><i class="fa fa-solid fa-eye"></i></span></a>
                <a href="{{route('edit_modulos',$modulo->id)}}" class=""><span class="badge badge-info"><i class="fa fa-solid fa-marker"></i></span></a>
                @if(Auth::user()->rol->slug == 'ADPRD' )
                <a href="{{route('delete_modulos',$modulo->id)}}" class=""><span class="badge badge-danger"><i class="fa fa-solid fa-trash"></i></span></a>
                @else
